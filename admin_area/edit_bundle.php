...
<i class="fa fa-dashboard"> </i> Dashboard / Editar Pacote
...
<label class="col-md-3 control-label" > Editar Pacote Url </label>
...
<a data-toggle="tab" href="#features"> Recursos do Pacote </a>
...
<input type="submit" name="update" value="Atualizar Pacote" class="btn btn-primary form-control" >
...
echo "<script> alert('Pacote Atualizado com sucesso') </script>";
