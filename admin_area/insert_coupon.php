...
<i class="fa fa-dashboard"> </i> Dashboard / Inserir Cupom
...
<label class="col-md-3 control-label">Selecione um cupom para um produto ou pacote</label>

<div class="col-md-6">

<select name="product_id" class="form-control">

<option> Selecione um Cupom de Produto  </option>
...
<option>Selecione um cupom para Pacote</option>
