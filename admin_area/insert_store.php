...
<i class="fa fa-dashboard" ></i> Dashboard / Inserir Loja
...
<input type="submit" name="submit" value="Inserir Loja" class="btn btn-primary form-control">
...
echo "<script>alert('Nova coluna da loja inserida')</script>";
