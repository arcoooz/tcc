...
<i class="fa fa-dashboard"></i> Dashboard / Editar Relação
...
<label class="col-md-3 control-label"> Selecione o Pacote  </label>
...
<input type="submit" name="update" class="btn btn-primary form-control" value="Atualizar Relação">
...
echo "<script>alert('Relação Atualizada')</script>";
