...
<i class="fa fa-dashboard" ></i> Dashboard / Inserir Tipo de Consulta
...
<input type="submit" name="submit" class="btn btn-primary form-control" value="Inserir Tipo de Consulta">
