...
<i class="fa fa-dashboard" ></i> Dashboard / Editar Loja
...
<label class="col-md-3 control-label"> Título da Loja : </label>
...
<label class="col-md-3 control-label"> Url da Loja : </label>
...
<input type="submit" name="update" value="Atualizar Loja" class="btn btn-primary form-control">
...
echo "<script>alert('Uma coluna da Loja foi atualizada')</script>";
