...
<i class="fa fa-dashboard"> </i> Dashboard / Inserir Pacote
...
<label class="col-md-3 control-label" > Título do Pacote </label>
...
<label class="col-md-3 control-label" > Url do Pacote </label>
...
Exemplo de Url de Pacote : camiseta-regata-azul
...
<label class="col-md-3 control-label" > Imagem do Pacote 1 </label>
...
<label class="col-md-3 control-label" > Imagem do Pacote 2 </label>
...
<label class="col-md-3 control-label" > Imagem do Pacote 3 </label>
...
<label class="col-md-3 control-label" > Preço do Pacote </label>
...
<label class="col-md-3 control-label" > Preço de Venda do Pacote </label>
...
<label class="col-md-3 control-label" > Palavras-chave do Pacote </label>
...
<label class="col-md-3 control-label" > Guias do Pacote </label>
...
<a data-toggle="tab" href="#description"> Descrição do Pacote </a>

</li>

<li>

<a data-toggle="tab" href="#features"> Características do Pacote </a>
...
<label class="col-md-3 control-label" > Label do Pacote </label>
...
<input type="submit" name="submit" value="Inserir Pacote" class="btn btn-primary form-control" >
...
echo "<script>alert('Pacote inserido com sucesso!!')</script>";
