...
<input type="submit" name="update" value="Atualizar Usuário" class="btn btn-primary form-control">
...
echo "<script>alert('Usuário atualizado com sucesso, fazer login novamente')</script>";
