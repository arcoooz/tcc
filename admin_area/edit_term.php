...
<i class="fa fa-dashboard"></i> Dashboard / Editar Termos
...
<input type="submit" name="update" value="Atualizar Termo" class="btn btn-primary form-control" >
...
echo "<script>alert('Termo atualizado ')</script>";
