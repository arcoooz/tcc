...
<label class="col-md-3 control-label"> Início Sobre Nós : </label>
...
<input type="submit" name="submit" value="Página Sobre Nós" class="btn btn-primary form-control">
...
echo "<script>alert('Página Sobre Nós Atualizada')</script>";
