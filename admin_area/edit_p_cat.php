...
<i class="fa fa-dashboard"></i> Dashboard / Editar Categoria de Produto
...
<label class="col-md-3 control-label" >Mostrar como top Categoria de Produtos</label>
...
<label class="col-md-3 control-label" > Selecione uma imagem da Categoria de Produto</label>
...
echo "<script>alert('Categoria de Produtos foi atualizado')</script>";
