...
<i class="fa fa-dashboard"> </i> Dashboard / Editar Cupom
...
<label class="col-md-3 control-label">Título Cupom </label>
...
<label class="col-md-3 control-label"> Valor Cupom </label>
...
<label class="col-md-3 control-label"> Selecione cupom para produto ou pacote </label>
...
<option>Selecione cupom para pacote</option>
...
echo "<script>alert('Cupom atualizado com sucesso')</script>";
