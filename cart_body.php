...
<p class="text-muted" > Você tem <?php echo $count; ?> item(s) no carrinho. </p>
...
Ir ao Checkout <i class="fa fa-chevron-right"></i>
...
echo "<script>alert('Seu cupom expirou')</script>";
...
echo "<script>alert('Cupom aplicado com sucesso')</script>";
...
echo "<script>alert('Produto inexistente no carrinho')</script>";
...
echo "<script> alert('Este cupom não é válido') </script>";
...
<h3 class="text-center"> Produtos que talvez você goste </h3>
