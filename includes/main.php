...
<!-- Página inicial de todas as páginas do Ecommerce para evitar repetição de código -->
<body>
      ...
      <div class="container clearfix">
        ...
        <nav class="main-nav">
          ...
          <li class="categories__item">
            ...
            <li style="display:none;" class="categories__item">
              ...
              <div class="dropdown dropdown--lookbook">
                <div class="clearfix">
                  ...
                  <div class="dropdown__half">
                    ...
                    <ul class="dropdown__items">
                      <li class="dropdown__item">
                        <a href="#" class="dropdown__link">Editar Conta</a>
                      </li>
                      <li class="dropdown__item">
