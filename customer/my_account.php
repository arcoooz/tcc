...
<strong> Atenção! </strong> Por favor, confirme seu e-mail e se você não recebeu seu e-mail de confirmação
...
echo "<script>alert('Seu e-mail de confirmação foi enviado, verifique sua caixa de entrada')</script>";
