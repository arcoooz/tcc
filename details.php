  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Ver </span>Produtos
      </div>
      <p class="nero__text">
      </p>
    </div>
...
Preço do Produto: <del> R$ $pro_price </del><br>

Preço Venda: R$ $pro_psp_price
...
Preço do Pacote : <del> R$ $pro_price </del><br>

Preço de Venda do Pacote: R$ $pro_psp_price
...
echo "<script>alert('Você deve fazer login para adicionar produtos a lista de desejos!')</script>";
...
echo "<script>alert('Este produto já foi adicionado a lista de desejos')</script>";
...
echo "<script> alert('Produto inserido a lista de desejos') </script>";
...
<h3 class="text-center"> Você também pode gostar destes produtos: Fornecemos os 3 principais itens de produtos. </h3>
