  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Cadastre-se</span> na BlackPearl
      </div>
      <p class="nero__text">
      </p>
    </div>
...
echo "<script>alert('Email já registrado, tente outro')</script>";
...
$from = "suporte@blackpearl.com";

$message = "

<h2>
Confimação de email By Computerfever.com $c_name
</h2>
...
echo "<script>alert('Favor Selecionar o Captcha, Tente novamente')</script>";
